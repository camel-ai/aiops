...
# 云查询相关路由
@app.route('/api/chat/confirm-project', methods=['POST'])
def confirm_project():
    return cloud_controller.handle_project_selection()

@app.route('/api/chat/confirm-cloud', methods=['POST'])
def confirm_cloud():
    return cloud_controller.handle_cloud_selection()

@app.route('/api/chat/confirm-region', methods=['POST'])
def confirm_region():
    return cloud_controller.handle_region_selection()

@app.route('/api/chat/confirm-products', methods=['POST'])
def confirm_products():
    return cloud_controller.handle_product_selection()

@app.route('/api/chat/cloud-query', methods=['POST'])
def cloud_query():
    return cloud_controller.handle_cloud_query()
